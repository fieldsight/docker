...
#BROKER_URL = 'amqp://guest:guest@172.17.0.3:5672//'
#ADMINS = [('Amulya', 'awemulya@gmail.com'),]
#ADMINS = [('Amulya', 'awemulya@gmail.com'),('saroj', 'raesaroj16@gmail.com'), ('sanip','saneprijal@gmail.com'),('santosh', 'skhatri.np@gmail.com')]
